...
class Content_profil extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('bkpsdm/content_profil.php', $data);
    ...
    public function update_data()
    {
        ...
        $this->form_validation->set_rules('foto_profil', 'Foto Profil', 'trim|xss_clean', [
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('bkpsdm/content_ubahUser', $data);
            ...
            redirect('bkpsdm/content_profil');
        }
    }
