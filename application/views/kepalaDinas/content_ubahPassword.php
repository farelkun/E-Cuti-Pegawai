            ...
            <div class="x_panel">
                <div class="x_content">
                    <div class="col-lg-8">
                        ...
                        <?php echo form_open_multipart('kepalaDinas/content_ubahPassword/update'); ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <small><span class="text-danger"><i><?php echo form_error('pwlama'); ?></i></span></small>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <small><span class="text-danger"><i><?php echo form_error('pwbaru'); ?></i></span></small>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="pwbaru" class="col-sm-2 col-form-label">Konfirmasi Password baru</label>
                            <div class="col-sm-10">
                                <input type="password" class="form-control" id="pwbaru2" name="pwbaru2" placeholder="masukkan ulang password baru">
                                <small><span class="text-danger"><i><?php echo form_error('pwbaru2'); ?></i></span></small>
                            </div>
                        </div>
                        <div class="ln_solid"></div>
