            ...
            <div class="x_panel">
                <div class="x_content">
                    <div class="col-lg-8">
                        ...
                        <?php echo form_open_multipart('bupati/content_cuti/buatsurat'); ?>
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2">Ttd basah </br>Sekda</label>
                            <div class="col-sm-10">
                                <img src="<?php echo base_url(); ?>assets/production/images/<?php echo $sekda['ttd_basah'] ?>" width="90" height="110">
                            </div>
                        </div>
                        <div class="ln_solid"></div>
                        <div class="form-group row justify-content-end">
                            <div class="col-sm-20">
                                <a href="<?php echo base_url('bupati/content_cuti'); ?>" class="btn btn-warning">Kembali</a>
