                ...
                <div class="x_content">
                    <div class="col-lg-8">
                        ...
                        <?php foreach ($user as $usr) { ?>
                            <?php echo form_open_multipart('pegawai/content_profil/update_data'); ?>
                                ...
                                <div class="col-sm-10">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            ...
                                            <input type="hidden" id="oldttd" name="oldttd" value="<?php echo $usr->ttd_basah ?>">
                                        </div>
                                        <div class="col-sm-9">
                                            <div class="custom-file">
                            ...
                            <div class="form-group row justify-content-end">
                                <div class="col-sm-20">
                                    <a href="<?php echo base_url('pegawai/content_profil'); ?>" class="btn btn-warning ">Kembali</a>
