        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_content">
                    ...
                    <br>
                    <br>
                    <h4 style="float: right">Hormat Saya,</h4>
                    ...
                    <br>
                    <br>
                    <a href="<?php echo base_url('admin/content_cuti'); ?>" class="btn btn-primary">Kembali</a>
                    <a href="<?php echo base_url('admin/content_cuti/print/' . $detail->id_surat); ?>" target="_BLANK" class="btn btn-warning">Print</a>
