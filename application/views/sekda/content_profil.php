        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_content">
                    ...
                    <a href="<?php echo base_url('sekda/content_permohonan'); ?>" class="btn btn-warning">Kembali</a>
                    <a href="<?php echo site_url('sekda/content_profil/edit/' . $tampil['id_user']) ?>" class="btn btn-primary btn-sm">Ubah</a>
                    </section>
                </div>
            </div>
        </div>
